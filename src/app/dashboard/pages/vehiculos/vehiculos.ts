...
export class Vehiculos implements OnInit {
  ...
  listarVehiculos() {
    const url = 'http://10.241.138.224:3005/api/vehiculos/all';
  ...
  crearVehiculo() {
    ...
    const url = 'http://10.241.138.224:3005/api/vehiculos/register';
    let headers = this.getHeaders();
  ...
  guardarEdicion() {
    ...
    const url = `http://10.241.138.224:3005/api/vehiculos/${this.selectedId}`;
    let headers = this.getHeaders();
  ...
  eliminarVehiculo(id: number) {
    const url = `http://10.241.138.224:3005/api/vehiculos/${id}`;
    let headers = this.getHeaders();
